    ...
    >
      ...
      <g>
        <MotionPath id="first-lane" color="blue">
          <path
            className="cls-5"
            d="M0,.5h190.71c28.9,0,56.61,11.48,77.04,31.91l37.76,37.76c21.1,21.1,49.73,32.96,79.57,32.96h233.81"
          />
        </MotionPath>
        <MotionPath id="second-lane" color="blue">
          <path
            className="cls-3"
            d="M0,82.91h190.71c28.9,0,56.61,5.74,77.04,15.96l37.76,18.88c21.1,10.55,49.73,16.48,79.57,16.48h233.81"
          />
        </MotionPath>
        <MotionPath id="third-lane" color="blue">
          <path
            className="cls-2"
            d="M0,165.33h190.71c28.9,0,56.61,0,77.04,0h37.76c21.1,0,49.73,0,79.57,0h233.81"
          />
        </MotionPath>
        <MotionPath id="fourth-lane" color="blue">
          <path
            className="cls-1"
            d="M0,247.74h190.71c28.9,0,56.61-5.74,77.04-15.96l37.76-18.88c21.1-10.55,49.73-16.48,79.57-16.48h233.81"
          />
        </MotionPath>
        <MotionPath id="fifth-lane" color="blue">
          <path
            className="cls-4"
            d="M0,330.15h190.71c28.9,0,56.61-11.48,77.04-31.91l37.76-37.76c21.1-21.1,49.73-32.96,79.57-32.96h233.81"
          />
        </MotionPath>
      </g>
    </svg>
